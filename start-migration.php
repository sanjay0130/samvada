...
/* 
    ...
    echo 'Default calendar view updated for all active userssssss <br>';
    */
...
$userQuery = $adb->pquery("SELECT id FROM vtiger_users WHERE user_name=?", [$username]);
$adminUserId = $adb->query_result($userQuery, 0, 'id');

// Load user
$current_user = CRMEntity::getInstance('Users');
$current_user->retrieve_entity_info($adminUserId, 'Users');
$current_user->id = $adminUserId;
$current_user->column_fields['id'] = $adminUserId;
