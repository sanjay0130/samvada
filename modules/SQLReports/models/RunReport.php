...
class SQLReports_RunReport_Model extends Vtiger_DetailView_Model {
	/**
	...
	public static function getInstance($moduleName,$recordId) {
		$modelClassName = Vtiger_Loader::getComponentClassName('Model', 'RunReport', $moduleName);
		$instance = new $modelClassName();

		$moduleModel = Vtiger_Module_Model::getInstance($moduleName);
		$recordModel = SQLReports_Record_Model::getCleanInstance($recordId, $moduleName);
	...
	public function getDetailViewLinks($linkParams='') {
		...
		$detailViewLinks[] = array(
			...
			'linkicon' => 'xlsx.png'
                ...
                /*$detailViewLinks[] = array(
			'linklabel' => vtranslate('LBL_REPORT_EXPORT_PDF', $moduleName),
			'linkurl' => $recordModel->getReportPDFURL(),
			'linkicon' => 'pdf.png'
		);*/
