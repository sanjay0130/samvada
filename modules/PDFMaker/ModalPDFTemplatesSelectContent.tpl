                   ...
                   <form class="form-horizontal contentsBackground" id="exportSelectDFMakerForm" method="post" action="index.php{if $ATTR_PATH neq ""}?{$ATTR_PATH}{/if}" novalidate="novalidate">
                        ...
                        <div class="modal-body tabbable">
                            ...
                            {/if}
                                <br>
                            <div class="row">
                                <h5>{vtranslate('Tax Year', $MODULE)}</h5>
                            </div>
                            <div class="row">
                                <select class="col-lg-12 select2" name="tax_year" id="tax_year">
                                    {for $year=date('Y')-5 to date('Y')}
                                        <option {if $year eq date('Y')}selected{/if}>{$year}</option>
                                    {/for}
                                </select>
                            </div>
                        </div>
