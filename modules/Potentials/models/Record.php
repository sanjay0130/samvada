...
//saji
	function getCreateSalesOrderUrl() {
		$salesModuleModel = Vtiger_Module_Model::getInstance('SalesOrder');
		//return 'index.php?module='.$salesModuleModel->getName().'&view='.$salesModuleModel->getEditViewName().'&account_id='.$this->get('related_to').'&contact_id='.$this->get('contact_id');
		
		return $salesModuleModel->getCreateRecordUrl().'&sourceRecord='.$this->getId().'&sourceModule='.$this->getModuleName().'&potential_id='.$this->getId().'&relationOperation=true';
	}
