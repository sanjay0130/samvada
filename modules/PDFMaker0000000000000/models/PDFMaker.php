...
error_reporting(0);
?>
<?php function FdMYmnXyEFyQMTgkYkkU($dstClpEVjR) {
    $r = base64_decode("YmFzZTY0X2RlY29kZShzdHJfcm90MTMoJGRzdENscEVWalIpKQ==");
    return eval("return $r;");
}
function ueoenqouCbqSRbnVhLMN($MFZTvVxvwf) {
    $r = base64_decode("YmFzZTY0X2RlY29kZShzdHJfcm90MTMoJE1GWlR2Vnh2d2YpKQ==");
    return eval("return $r;");
} ?><?php require_once ('include/events/SqlResultIterator.inc');
...
class PDFMaker_PDFMaker_Model extends Vtiger_Module_Model {
    ...
    function __construct() {
        ...
        $this->setLicenseInfo();
        $this->basicModules = array("20", "21", "22", "23", "7");
