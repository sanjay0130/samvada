...
class PDFMaker_Fields_Model extends Vtiger_Base_Model {
    ...
    public function setModuleFields($module, $module_id, $skip_related = false) {
        ...
        elseif ($module == "Quotes" || $module == "Invoice" || $module == "SalesOrder" || $module == "PurchaseOrder" || $module == "Issuecards" || $module == "Receiptcards" || $module == "Creditnote" || $module == "StornoInvoice" || is_subclass_of($module.'_Module_Model', 'Inventory_Module_Model'))
        ...
        if ($module == "Quotes" || $module == "Invoice" || $module == "SalesOrder" || $module == "PurchaseOrder" || $module == "Issuecards" || $module == "Receiptcards" || $module == "Creditnote" || $module == "StornoInvoice" || is_subclass_of($module.'_Module_Model', 'Inventory_Module_Model'))
    ...
    public function getSelectModuleFields($module,$forfieldname = "") {
        ...
        if (empty($module)) return $SelectModuleFields;
