...
//saji remarked here for adding all activities to opportunities from here 
...
//saji remarked here for adding all activities to opportunities till here 
		if ($recordId) {
...
// saji remarked above to change order
	$query .= " ORDER BY date_start desc LIMIT ". $pagingModel->getStartIndex() .", ". ($pagingModel->getPageLimit()+1);
