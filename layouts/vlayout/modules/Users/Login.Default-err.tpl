		...
		<div class="container-fluid login-container">
			<div class="row-fluid">
				<div class="span3">
					...
					<div class="logo"><img src="layouts/vlayout/skins/images/logo-orign.png">
				...
				<div class="span9">
					<div class="helpLinks">
						<a href="http://www.communitysamvada.com/">Website</a> | 
						<a href="http://n15a.communitysamvada.com/">Magazine</a> | 
						<a href="http://n15a.communitysamvada.com/index.php?option=com_news&view=listlocalnews/">News </a> | 
                                                <a href="http://n15a.communitysamvada.com/index.php?option=com_residentnews&view=listresidentnews">People </a> | 
                                                <a href="http://n15a.communitysamvada.com/index.php?option=com_directory&view=guidepage">Guide </a> | 
						<a href="http://n15a.communitysamvada.com/index.php?option=com_classifieds&view=listclassifieds">Bazaar</a> 
					</div>
				</div>
			</div>
			<div class="row-fluid">
							...
							<div class="row-fluid">
								<div class="span6">
									<div class="carousal-container">
										<div><h2> Get more out of CRM </h2></div>
										<ul class="bxslider">
											<li>
												<div id="slide01" class="slide">
													<img class="pull-left" src="{vimage_path('SaImg1.png')}">
													<img class="pull-right" src="{vimage_path('android.png')}"/>
												</div>
											</li>
											<li>
												<div id="slide02" class="slide">
													<img class="pull-left" src="{vimage_path('SaImg2.png')}"/>
													<img class="pull-right" src="{vimage_path('android.png')}"/>
												</div>
											</li>
											<li>
												<div id="slide03" class="slide">
													<img class="pull-left" src="{vimage_path('SaImg3.png')}"/>
													<img class="pull-right" src="{vimage_path('android.png')}"/>
												</div>
											</li>
											<li>
												<div id="slide04" class="slide">
													<img class="pull-left" src="{vimage_path('SaImg4.png')}"/>
													<img class="pull-right" src="{vimage_path('android.png')}"/>
												</div>
											</li>
											<li>
												<div id="slide05" class="slide">
													<img class="pull-left" src="{vimage_path('SaImg5.png')}"/>
													<img class="pull-right" src="{vimage_path('android.png')}"/>
												</div>
											</li>
			...
			<div class="control-group">
				...
				<div class="controls">
											...
											<div class="login-subscript">
												<small> Powered by CRM {$CURRENT_VERSION}</small>
											</div>
				</div>
					...
					<div class="row-fluid">
						...
						<div class="span6 pull-right" >
							<div class="pull-right footer-icons">
								...
								<a href="https://www.facebook.com/15acommunitysamvada"><img src="layouts/vlayout/skins/images/facebook.png"></a>
								&nbsp;<a href="https://twitter.com/><img src="layouts/vlayout/skins/images/twitter.png"></a>
								&nbsp;<a href="https://www.linkedin.com/"><img src="layouts/vlayout/skins/images/linkedin.png"></a>
								&nbsp;<a href="http://www.youtube.com/"><img src="layouts/vlayout/skins/images/youtube.png"></a> 
							</div>
						</div>
					</div>   
				</div>    
