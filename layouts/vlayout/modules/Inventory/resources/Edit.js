...
Vtiger_Edit_Js("Inventory_Edit_Js",{
	...
	calculateTotalAfterDiscount: function(lineItemRow) {
		...
		var totalAfterDiscount = productTotal - discountTotal;   //sajikumar
...
//saji		var amount = netTotal - finalDiscountValue;
...
/*saji	var grandTotal = parseFloat(netTotal) - parseFloat(discountTotal) + parseFloat(shippingHandlingCharge) + parseFloat(shippingHandlingTax); */
		var grandTotal = parseFloat(netTotal) - parseFloat(discountTotal) - parseFloat(shippingHandlingCharge);
	...
	/*   var message = app.vtranslate('OVERWRITE_EXISTING_MSG1')+app.vtranslate('SINGLE_'+data['source_module'])+' ('+data['selectedName']+') '+app.vtranslate('OVERWRITE_EXISTING_MSG2')+"Invent";
	...
	*	}); 
	...
	calculatePreTaxTotal : function() {
		...
		var shippingHandlingCharge = this.getShippingAndHandling();
		var finalDiscountValue = this.getFinalDiscountTotal();
/* saji		var preTaxTotal = netTotal+shippingHandlingCharge-finalDiscountValue; */
