...
<!-- remove entire row saji from here 
        <tr>
            <td width="83%">
...
<!-- converting shipping into additional Discount from here added the below block 11032016--> 
        <tr>
            <td width="83%">
	<span class="pull-right">(-)&nbsp;<b>Additional Discount: </b></span> 
            </td>
            <td>
<!-- converting shipping into additional Discount till here added the below block 11032016 -->


		<!--   <span  class="pull-right"><input type="hidden" id="shipping_handling_charge" name="shipping_handling_charge" data-validation-engine="validate[funcCall[Vtiger_PositiveNumber_Validator_Js.invokeValidation]]" type="text" class="lineItemInputBox" value="{if $FINAL.shipping_handling_charge}{$FINAL.shipping_handling_charge}{else}0{/if}" /></span>	   -->
     ...
     <!-- converting shipping into additional Discount from here added the below block2 11032016 -->
            </td>
        </tr>
     <!-- converting shipping into additional Discount till here added the below block2 11032016 -->
		
	<!--	<tr>
			<td width="83%">
				 <span class="pull-right"><b>{vtranslate('LBL_PRE_TAX_TOTAL', $MODULE_NAME)} </b></span> 
				 <span class="pull-right"><b>Net Total After Discounts </b></span> 
			</td>
			<td>
...
<!-- </td> 
    ...
    <!--    <tr> -->
            <td width="83%">
<span  id="tax_final" class="redColor" class="pull-right tax_final">{if $FINAL.tax_totalamount}{$FINAL.tax_totalamount}{else} {/if}</span> 
...
<!-- <span class="pull-right">(+)&nbsp;<b><a href="javascript:void(0)" id="shippingHandlingTax">{vtranslate('LBL_TAX_FOR_SHIPPING_AND_HANDLING',$MODULE)} </a></b></span>  -->
				...
				<span   type="hidden" class="pull-right shipping_handling_tax" id="shipping_handling_tax">{if $FINAL.shtax_totalamount}{$FINAL.shtax_totalamount}{else}0{/if}</span> 
            </td>
             <!-- <td> 
