			...
			{foreach item=RECORD key=KEY from=$ACTIVITIES}
				...
				<div class="activityEntries">
					...
					<div class="summaryViewEntries">
						...
						{* Added saji : for bring notes into opportunities. from here *}
						<br>
						<span class="redColor">Notes:  </span>
						{vtranslate($RECORD->getDescriptionValue(),$MODULE_NAME)}&nbsp;-&nbsp; 
						{* Added saji : for bring notes into opportunities. till here *}
