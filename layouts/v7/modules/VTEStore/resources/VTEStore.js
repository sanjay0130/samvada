                ...
                if(err === null) {
                    ...
                    for (var i = 0; i < total; i++){
                        newPannelHtml += [  "<li>",
                                                ...
                                                "<a data-name='" + settinglabels[i] +"' href='" + settingLinks[i]+"&openpremium=1" + "' class='menuItemLabel ui-draggable ui-draggable-handle' data-instafilta-hide='false' style='display: inline-block;' target='_blank'>" + settinglabels[i],
