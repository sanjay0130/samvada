...
* START
* May 2018
* Customization done to calculate balance on received change
* Abdelhadi Fennane
*/
			jQuery('#received').change(function(e) {
            ...
            jQuery("#grandTotal").on('DOMSubtreeModified', function () {
			  jQuery('#received').trigger('change');
			});
...
* END
* May 2018
* Customization done to save contact and appointment details into VTigerCRM
* Abdelhadi Fennane
*/
        },
});
